...
<body>
	...
	?>
	<form id="versManuel" method="POST" action="../index.php">
		<input id="manuel" type="hidden" name="manuel" value="v_manuel"/>
	</form>
	<center>
		<div class="grille-globale">
			<div class="grille-verticale1-btn">
				...
				<form id="formInvisible" method="POST" action="../index.php">
					...
					<input id="encyclopedie_manuel" type="hidden" value="v_encyclopedie_manuel" name="encyclopedie_manuel"/>
				</form>
			</div>
			<div id="contenuEtude">
